 ...
 * lead to a {@link edu.gatech.seclass.GTNow.GroupDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link edu.gatech.seclass.GTNow.GroupListFragment} and the item details
 * (if present) is a {@link edu.gatech.seclass.GTNow.GroupDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link edu.gatech.seclass.GTNow.GroupListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class GroupListActivity extends GroupActivity
    ...
    /**
     * Callback method from {@link edu.gatech.seclass.GTNow.GroupListFragment.Callbacks}
